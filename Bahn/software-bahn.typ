...
== Near Field Communication (NFC) <sec_nfc-bahn-sw>
...
== Bluetooth Low Energy (BLE) <sec-ble_bahn>
...
\
Es werden Auto spezifische Werte wie Rundenzeit oder Spielername übertragen. Die Daten werden paketiert und gesendet.
\
...
#figure(
  ...
  caption: [Datenpakete BLE Kommunikation],
) <fig-tmc5160driveroverview>



== Transmission Control Protocol (TCP) <sec_tcp_bahn>
