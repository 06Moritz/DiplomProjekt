...
== Motor 
*!* Als Motor wird ein 12V Gleichstrommotor verwendet, der über eine H-Brücke gesteuert wird. Die H-Brücke ermöglicht es, die Drehrichtung des Motors zu ändern und die Geschwindigkeit zu steuern. siehe @sec-hbridge
...
== Funkverbindung – BLE
https://www.analog.com/en/resources/technical-articles/understanding-architecture-bluetooth-low-energy-stack.html \
Bluetooth Low Energy (BLE) ist für die Übertragung von kleinen Datenmengen optmiert, dadurch auch Energiesparend. Es funktioniert mit einem Server-Client System. Das schnelle und einfache Verbinden ist ein weiter Pluspunkt.
Implementierung in unserem Fall: 
